...
def main(args, dataset, name):
    ...
    model = load_pretrained(args['models']).to(args['device'])
    model.eval()
    readout = AvgPooling()
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--models', choices=['gin_supervised_contextpred',
                                                  'gin_supervised_infomax',
                                                  'gin_supervised_edgepred',
                                                  'gin_supervised_masking'],
                        help='Pre-trained models to use for computing molecule embeddings')
