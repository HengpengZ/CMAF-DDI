...
class BaseModel(object):
    ...
    def load_model(self, filename: str):
        # we only save models's weight instead of the whole models
        self.model.load_weights(filename)

    def load_best_model(self):
        print('Logging Info - Loading models checkpoint: %s.hdf5' % self.config.exp_name)
    ...
    def load_swa_model(self):
        print(f'Logging Info - Loading SWA models checkpoint: {self.config.exp_name}_swa.hdf5')
