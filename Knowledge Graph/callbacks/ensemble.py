...
class SWA(Callback):
    ...
    def __init__(self, swa_model, checkpoint_dir, model_name, swa_start=1):
        """
        :param swa_model: the models that we use to store the average of the weights once SWA begins
        :param checkpoint_dir: the directory where the models will be saved in
        :param model_name: the name of models we're training
    ...
    def on_train_begin(self, logs=None):
        ...
        '''Note: I found deep copy of a models with customized layer would give errors'''
        # self.swa_model = copy.deepcopy(self.models)  # make a copy of the models we're training
        ...
        '''
        # self.swa_model = keras.models.clone_model(self.models)
    ...
    def on_train_end(self, logs=None):
        print(f'Logging Info - Saving SWA models checkpoint: {self.model_name}_swa.hdf5')
        self.swa_model.save_weights(os.path.join(self.checkpoint_dir,
                                                 f'{self.model_name}_swa.hdf5'))
        print('Logging Info - SWA models Saved')
